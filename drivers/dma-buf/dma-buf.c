...
#ifdef CONFIG_HMD_FEATURE_LOWMEM_DBG
#include <linux/soc/qcom/lowmem_dbg.h>
#endif /* CONFIG_HMD_FEATURE_LOWMEM_DBG */
 ...
 */
inline int hmd_is_dma_buf_file(struct file *file)
{
