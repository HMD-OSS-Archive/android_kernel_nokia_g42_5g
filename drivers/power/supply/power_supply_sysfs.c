...
static const char * const POWER_SUPPLY_POWER_NOW_TEXT[] = {
	[POWER_SUPPLY_TYPE_UNKNOWN]	= "Unknown",
	[POWER_SUPPLY_TYPE_USB]		= "SDP",
	[POWER_SUPPLY_TYPE_USB_DCP]	= "DCP",
	[POWER_SUPPLY_TYPE_USB_PD]	= "PD",
	[POWER_SUPPLY_TYPE_USB_FLOAT]= "FLOAT",
	[POWER_SUPPLY_TYPE_USB_CDP]	= "CDP",
	[QTI_POWER_SUPPLY_TYPE_USB_HVDCP_3]	= "HVDCP_3",
};
...
static const char * const POWER_SUPPLY_AUTHENTIC_TEXT[] = {
	[POWER_SUPPLY_TECHNOLOGY_UNKNOWN]	= "PM7250B",
};

static const char * const POWER_SUPPLY_CALIBRATE_TEXT[] = {
	[POWER_SUPPLY_TECHNOLOGY_UNKNOWN]	= "PM7250B",
};
...
static struct power_supply_attr power_supply_attrs[] = {
	...
	POWER_SUPPLY_ENUM_ATTR(AUTHENTIC),
	...
	POWER_SUPPLY_ENUM_ATTR(POWER_NOW),
	...
	POWER_SUPPLY_ENUM_ATTR(CALIBRATE),
