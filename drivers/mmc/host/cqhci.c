...
/* req APOLLO-19,chenhao,20220228,add,begin */
	cqhci_writel(cq_host, cqhci_readl(cq_host, CQHCI_RMEM) & ~WP_EXCEPTION, CQHCI_RMEM);
/* req APOLLO-19,chenhao,20220228,add,end */
