...
#if 0
/* added by chenshitao for Q4801-132 (20220819) begin */
...
static char version[20]="unknown";
...
#endif
/* added by chenshitao for Q4801-132 (20220819) end */
#endif
...
int ili_sleep_handler(int mode)
{
	...
	case TP_SUSPEND:
		...
		if ((ilits->gesture) || (ilits->prox_face_mode == true) || gesture_dubbleclick_en) {
...
static void ontim_dev_get_ilitek_info(void)
{
	...
	if (strstr(saved_command_line, "ili9883c_90hz_hd_lce_video") != NULL)
	{
		snprintf(lcdname, sizeof(lcdname), "lce-ili9883c");
		snprintf(vendor_name, sizeof(vendor_name), "lce-ili9883c");
		fw_ver = (ilits->chip->fw_ver >> 8) & 0xFF;
		snprintf(version, sizeof(version),"fw:%d.%d VID:0x08",fw_ver,((ilits->chip->fw_ver) & 0xff));
	}
}
#endif
/* added by chenshitao for Q4801-132 (20220819) end */
