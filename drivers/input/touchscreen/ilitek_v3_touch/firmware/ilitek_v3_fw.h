...
#define DEF_INI_NAME_PATH		"lce_mp.ini"
#define DEF_FW_FILP_PATH		"lce_9883c.hex"
#define DEF_INI_REQUEST_PATH	"lce_mp.ini"
#define DEF_FW_REQUEST_PATH		"lce_9883c.hex"
