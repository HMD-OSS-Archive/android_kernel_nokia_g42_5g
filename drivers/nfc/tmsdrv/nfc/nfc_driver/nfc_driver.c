...
static inline int i2c_master_block_recv(struct nfc_info *nfc, uint8_t *buf, size_t count,
                          int timeout)
{
    int ret;
    TMS_DEBUG("Start+\n");
...
//Added by yangjiangjiang for Q5003-223 (20230104) Begin
...
//Added by yangjiangjiang for Q5003-223 (20230104) End
