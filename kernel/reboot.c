 ...
 */
 ///*Ramdump UI Display porting by zhongli.liu start*/
#ifdef CONFIG_SUPPORT_CRASH_REASON
#ifndef HMD_MP_VERSION
extern void dump_set_fatal_reboot(void);
#endif
#endif // CONFIG_SUPPORT_CRASH_REASON		
 ///*Ramdump UI Display porting by zhongli.liu end*/
...
/*req SDW-605 SDT-3885 20230522 xulanqing add begin*/
...
#endif
/*req SDW-605 SDT-3885 20230522 xulanqing add end*/
...
#ifndef HMD_MP_VERSION
	if (cmd && !strncmp(cmd, "FatalReboot:", 12)) {
		      dump_set_fatal_reboot();
		      pr_emerg("panic '%s'\n", cmd);
