...
enum pon_restart_reason {
	...
	PON_RESTART_REASON_IMEI_CORRUPTED	= 0x21, // Add by david.zhou for IMEI missing or corrupted.
	PON_RESTART_REASON_MODEM_UNSIGNED	= 0x22, // Add by zhixue.chang for reboot to red screen if check modem is not signed 20230118
};
